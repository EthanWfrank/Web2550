...
public partial class EthanRContext : DbContext
{
    public EthanRContext()
    {
    }

    public EthanRContext(DbContextOptions<EthanRContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=data.cnt.sast.ca,24680;Database=Ethan_R;User Id=efrank3;Password=aZx243mnb5342@; Encrypt=False;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ItemsOffered>(entity =>
        {
            ...
            entity.Property(e => e.OfferedStatus).HasDefaultValue(true);
